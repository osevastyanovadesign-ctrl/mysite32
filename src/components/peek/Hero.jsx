...
// The Encounter — a calm, editorial hero. The intro curtain melts away
// to reveal this: a white mug with the Eva dachshund print, beside the
// headline. Light, generous, uncluttered.
    ...
    >
      <div className="relative w-full">
        ...
        <div className="absolute inset-0 flex items-center justify-end px-6 md:px-10 lg:px-16">
          ...
          >
            {t("hero.line1")} <span className="italic text-primary">{t("hero.accent")}</span> {t("hero.line2")}
          </motion.h1>
          <motion.p
